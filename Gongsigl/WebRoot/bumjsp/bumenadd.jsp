...
<form class="layui-form layui-form-pane" action="Javascript:void(0)">
	  <div class="layui-form-item">
	    ...
	    <div class="layui-input-inline">
	      	<input type="text" name="rname" id="rname" lay-verify="required" placeholder="请输入部门名" autocomplete="off" class="layui-input">
	    </div>
	  </div>
	  <br/><br/>
	  <div class="layui-form-item">
	    	<button class="layui-btn layui-btn-fluid" id="tijiao" lay-filter="addRole">新增部门</button>
	  </div>
</form>
...
<script type="text/javascript" src="../js/addjs/addbm.js"></script>
</body>
</html>