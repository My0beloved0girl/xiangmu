...
<form class="layui-form">
	...
	<!-- 请求的路径 -->
	<div class="layui-form-item layui-row layui-col-xs12" id="lujin">
	...
	<!-- 按钮代码 -->
	<div class="layui-form-item layui-row layui-col-xs12" id="zhixingti">
...
<script type="text/javascript" src="../js/addjs/addqx.js"></script>
</body>
</html>